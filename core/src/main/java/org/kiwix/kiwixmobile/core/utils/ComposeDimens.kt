...
object ComposeDimens {
  ...
  val TAB_SWITCHER_BOTTOM_PADDING = 96.dp
  val TAB_CARD_MIN_WIDTH = 140.dp
  const val TAB_CARD_ASPECT_RATIO = 0.80f
  val TAB_CARD_CORNER_RADIUS = 16.dp
  val TAB_PREVIEW_CORNER_RADIUS = 10.dp
  val TAB_BADGE_CORNER_RADIUS = 4.dp
  val TAB_FAVICON_SIZE = 18.dp
  val TAB_SWITCHER_TEXT_SIZE = 11.sp
  val CLOSE_TAB_ICON_SIZE = 16.dp
