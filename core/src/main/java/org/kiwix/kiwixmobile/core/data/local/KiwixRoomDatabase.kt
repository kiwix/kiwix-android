...
abstract class KiwixRoomDatabase : RoomDatabase() {
  ...
  // abstract fun networkLanguageDao(): NetworkLanguageDao
  // abstract fun recentSearchDao(): RecentSearchDao
  // abstract fun fetchDownloadDao(): FetchDownloadRoomDao
  // abstract fun newBookDao(): NewBookDao
  // abstract fun newBookmarksDao(): NewBookmarksDao
  // abstract fun newLanguageDao(): NewLanguagesDao
  // abstract fun newNotesDao(): NewNoteDao
  // abstract fun newRecentSearchDao(): NewRecentSearchDao
