...
class ManageExternalFilesPermissionDialogTest {
  @Test
  fun `invokeWith shows manage external files dialog and navigates to settings`() {
    ...
    val effect = ManageExternalFilesPermissionDialog(dialogShower)
